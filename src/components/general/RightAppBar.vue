    ...
    >
      <v-card-text>
        <div class="fcs tw-gap-4 tw-pb-4">
          ...
          <div>
            <h3 class="tw-font-bold tw-text-sm md:tw-text-base">
              Muhammad Iqra Djauhari
            </h3>
            <p class="mt-1 tw-mb-2 tw-text-xs md:tw-text-sm tw-text-[#808D93]">
              iqra@elabram.com
            </p>
            <v-chip :size="mobile ? 'x-small' : 'small'" color="primary-600">
              Employe
            </v-chip>
          </div>
        </div>
        ...
        <v-btn variant="text" prepend-icon="mdi-account-outline">
          ...
          <div class="tw-font-semibold tw-text-xs md:tw-text-sm">
            My Profile
          </div>
        </v-btn>
        <v-divider class="tw-my-2 tw-opacity-50" />
        <div class="tw-px-3">
          <!-- Toggle Dark mode -->
          <div class="tw-text-[10px] md:tw-text-xs tw-text-[#808D93]">
            Apperance
          </div>
          <div class="fcb">
            <div class="tw-font-semibold tw-text-xs md:tw-text-sm">
